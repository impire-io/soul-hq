...
| [`0008-the-first-hour.md`](0008-the-first-hour.md) | The first hour: guidance as a reading, never a store — the derived first-steps card on Home, the arrival principle (an act ends when the realm's own evidence shows the thing arrived), empty states that offer their act, and upstream ask #3 (the wrap's presence lease — announce on start, renew on a cadence, staleness read as gone). Decided 2026-08-24 ahead of its build, episode [0124](../../04-JOURNEY/0124-ecosystem-the-first-hour-and-the-presence-lease.md). |
