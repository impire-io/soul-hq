...
| 0004 | [`0004-the-waker.md`](0004-the-waker.md) | The waker — notify-triggered invocation: durable consumer per agent persona, admission probe, invocation templates (harness-agnostic by dot-path terminal mapping), the one-outcome-op reply obligation, token-lane and ephemeral credential lanes, failure authored by the waker's own persona | graduated from `agent-participation` (episode 0082); not yet built |
