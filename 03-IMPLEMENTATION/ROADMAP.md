...
**The second canon is decided, ahead of its build** ([episode
0154](../04-JOURNEY/0154-shell-the-second-canon.md), design
...
ecosystem horizon named at the top of this file. The arc lands as
three movements on one branch (tokens → chrome → screens), then the
idp fold takes the same tokens (session-and-ui.md §D30's companion).
...
8. **M-second-canon — the re-skin** (decided 2026-08-29, episode
   [0154](../04-JOURNEY/0154-shell-the-second-canon.md); design
   [`0011`](../02-DESIGN/soulstream-shell/0011-the-second-canon.md)):
   the Impire design system lands visual-for-visual — the token and
   component layer rewritten, the chrome's labeled sidebar, the 20
   render files re-classed with their markup assertions, Geist
   vendored under the standing offline gate, all ten screens then the
   idp fold. Gate: 0011 §9 — full `make check` green (fits, purity,
   banned words, offline render), no vocabulary change in the diff,
   the operator calling the canon held on before/after screens.
