...
| [soulstream-shell](#soulstream-shell--the-shell) | **v0.11.0-rc.3 — the first hour** ([episode 0127](../04-JOURNEY/0127-shell-the-first-hour-builds.md), design [`0008`](../02-DESIGN/soulstream-shell/0008-the-first-hour.md)): the derived first-steps card, the Around column reading the presence face, empty states that offer their act; before it the sheet-shape pass ([episode 0123](../04-JOURNEY/0123-shell-the-sheet-shape.md)) and rc.2's tools and approvals ([episode 0122](../04-JOURNEY/0122-ecosystem-the-shell-arc-lands.md)) | The byon soak at rc.3; the fresh-eyes install (0008 [O1] — the one test nobody has run); the operator lives on the candidate — what chafes decides |
...
- **M3.1 — first fleet milestone.** ✅ **Done 2026-08-19** ([episode
  ...
  **Next, now unblocked:** the declaration trigger vocabulary (research
  ...
  the Synadia BYON scope group stay named follow-ons.
...
identity `447ec6b`, unreleased): the admitted-but-inert defect is
...
7. **Later**: ~~sealing keys (D9 — unwrap-once, waits on Soulstream sealed
   ...
   D50–D53, `specs/005-sealing-custody` unreleased): the vault custodian
