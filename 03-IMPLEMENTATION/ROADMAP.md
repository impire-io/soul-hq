...
|---|---|---|
| [soulstream-core](#soulstream-core--the-record) | `v0.8.4` (renamed at 0070; the remote MCP node extracted to soulstream-mcp) — MVP + most of day-2 shipped; **the tenancy half designed** ([episode 0107](../04-JOURNEY/0107-ecosystem-platform-tenancy-guardrails.md), [`extensions/tenancy.md`](../02-DESIGN/soulstream-core/extensions/tenancy.md)): grant vocabulary, registry ensure-act (F1), and the two decided canonical-form clean breaks (A10 key-in-record, E3 acting-credential) | F1's ensure-act first (a live correctness gap — unknown-key is the shipped default for identity-plane-signed personas); the A10/E3/A9 clean-break cycle when scheduled; sealed-topics and eg-walker stay chafe-gated |
...
| [soulstream-identity](#soulstream-identity--the-name) | M1/M3/M4 shipped (+ Entra/OIDC lane, D25 registry dissolution, D28/D29 consumer-proven additions); **`v0.3.0` — M6's grants broker landed** ([episode 0105](../04-JOURNEY/0105-identity-the-grants-broker-lands.md): slice 1 + review pass merged, transport clause on the repo's own gate, CLI ceremony, runbook written) on 0104's graduated design (D30–D34 in [`grants.md`](../02-DESIGN/soulstream-identity/grants.md)) | ~~SC-005~~ **closed 2026-08-18** (the real-GitHub walk, run recorded in `specs/003-grants-broker/quickstart.md`) — every M6 criterion measured. **M7 designed: tenancy + guardrails** ([episode 0107](../04-JOURNEY/0107-ecosystem-platform-tenancy-guardrails.md), D35–D38 in [`tenancy.md`](../02-DESIGN/soulstream-identity/tenancy.md)) — builds behind the 0071 focus gate, order: secrets → evaluator → accounts; Bar 1's BYON arm an operator act. M2's node half check-off pending; M5 gated on demand; lane 3 behind the fold's exchange grant |
| [soulstream](#soulstream--the-product-the-house) | **v0.13.0-rc.6 tagged 2026-08-18** (awaiting push; pipeline feeds the tap) — the refresh arc ships: pins core v0.8.4 / workloads v0.4.0 / **shell v0.9.0 / idp v0.6.0** / archivist v0.3.0 ([episode 0103](../04-JOURNEY/0103-ecosystem-the-session-outlives-its-token.md)); before it rc.5's console arc (episodes [0100](../04-JOURNEY/0100-soulstream-v0-13-0-rc-2.md)/[0101](../04-JOURNEY/0101-shell-the-fronted-console-signs-in.md)/[0102](../04-JOURNEY/0102-shell-conversations-begin-and-end.md)) | RC soak toward v0.13.0 on the byon deployment; next product cycle picks up identity v0.3.0 (grants) and idp v0.7.0 (the knob) when it wires them; Phase 3 (tsnet) gated on fronting measured insufficient |
| [soulstream-idp](#soulstream-idp--the-fold) | **Every milestone shipped — M1–M5**, and **v0.4.2 wears the ecosystem's canon** ([episode 0090](../04-JOURNEY/0090-idp-the-fold-wears-the-canon.md), design D30); **v0.6.0 — the refresh grant** ([episode 0103](../04-JOURNEY/0103-ecosystem-the-session-outlives-its-token.md)); **v0.7.0 — the token-lifetime knob** ([episode 0106](../04-JOURNEY/0106-idp-the-token-lifetime-knob.md)): the first of 0104's two due demands closed, the deployment tunes revocation propagation; **physical-authenticator runbook run 2026-08-18** (Arc + cross-device phone passkey, all five steps pass, the rpId one-way door demonstrated — recorded in `specs/002-passkeys/quickstart.md`) | The second 0104 demand: the **RFC 8693 exchange grant**, spec first (audience is deployment-fixed today; the Article II argument rides Entra's own OBO support). Named horizons only otherwise (deferred audit rows, multi-issuer demand; per-client lifetimes when demanded) |
| [soulstream-shell](#soulstream-shell--the-shell) | **v0.8.0 — conversations begin and end in the shell** ([episode 0102](../04-JOURNEY/0102-shell-conversations-begin-and-end.md), design [0003](../02-DESIGN/soulstream-shell/0003-conversation-lifecycle.md)): start/close/archive from the surface, zero upstream additions; **v0.9.0 — session refresh** ([episode 0103](../04-JOURNEY/0103-ecosystem-the-session-outlives-its-token.md)): the bearer renews behind the session and the session ends honestly when it cannot; before that v0.7.0's PublicURL ([episode 0101](../04-JOURNEY/0101-shell-the-fronted-console-signs-in.md)) and the console arc ([episodes 0089](../04-JOURNEY/0089-ecosystem-wrap-in-the-house.md)/[0091](../04-JOURNEY/0091-ecosystem-the-shell-is-the-console.md)) | **v0.9.0 pinned and riding v0.13.0-rc.6** (tagged 2026-08-18, awaiting push) | The operator tries the whole system — evaluation decides what changes |
