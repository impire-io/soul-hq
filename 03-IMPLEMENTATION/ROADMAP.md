...
the ceremony and the authority cannot drift. The ProviderAPI arm's
D47 parity stays A8's BYON residue. The product's halves (SystemConn
wiring, an `accounts.*` client surface) ride whichever product cycle
