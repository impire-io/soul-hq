...
[`agents-as-infrastructure`](../01-RESEARCH/agents-as-infrastructure/README.md)
is open with five pre-registered bars; the shell's declare surface is
designed against the dispatcher's submit op once the research fixes
its shape. The 0071 focus is not repealed — this is its next chapter:
...
- **M3.1 — first fleet milestone.** ✅ **Done 2026-08-19** ([episode
  ...
  **Next, now unblocked:** the declaration trigger vocabulary (research
  ...
  0140](../04-JOURNEY/0140-ecosystem-the-focus-agents-as-infrastructure.md))
  — the standing dispatcher (submit-and-forget) is the focus; research
  [`agents-as-infrastructure`](../01-RESEARCH/agents-as-infrastructure/README.md)
  opened with five pre-registered bars, design 0004 §9's reversal
  condition fired.
...
7. **Next, named 2026-08-27:** the **agent declare surface** — the
   ...
   against the dispatcher's submit op once research
   [`agents-as-infrastructure`](../01-RESEARCH/agents-as-infrastructure/README.md)
   fixes its shape (its Bar 5 proves the loop reachable from
   pure-consumer position first).
