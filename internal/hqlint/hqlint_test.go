...
var (
	...
	components   = []string{"soulstream", "soulstream-core", "soulstream-workloads", "soulstream-identity", "soulstream-idp", "soulstream-shell"}
	legalTags    = map[string]bool{"soulstream": true, "soulrealm": true, "soulidentity": true, "soulnode": true, "soulfold": true, "soulhelm": true, "ecosystem": true, "core": true, "workloads": true, "identity": true, "idp": true, "shell": true, "mcp": true, "cli": true}
